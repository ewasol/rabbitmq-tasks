...
def main(consumer_id, binding_key):
    ...
    print(f' [*] Consumer {consumer_id} waiting for logs with binding key '
...
if __name__ == "__main__":
    import sys
    consumer_id = sys.argv[1] if len(sys.argv) > 1 else "Consumer"
    binding_key = sys.argv[2] if len(sys.argv) > 2 else "#"
